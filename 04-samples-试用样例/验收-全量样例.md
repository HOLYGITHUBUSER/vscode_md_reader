...
code --install-extension 07-artifacts-安装包/md-reader-v*.vsix --force
```
...
```json
{
  "name": "md-reader",
  "contributes": {
    "customEditors": [{ "viewType": "md-reader.editor", "priority": "default" }]
  }
}
```
